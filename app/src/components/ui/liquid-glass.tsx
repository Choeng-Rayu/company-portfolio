...
// Card Component - for wrapping content in glass effect
...
}> = ({ children, className = "", style = {}, onMouseEnter, onMouseLeave, onMouseMove }) => (
  <div
...
// SVG Filter Component (global, add once to app)
